...
Algoritmos supervisados (árboles de decisión, clasificación)
Algoritmos no supervisados (K-Means, jerárquico, DBSCAN)
Minería de reglas de asociación (Apriori)
Modelado de series de tiempo (Prophet)
Fundamentos de NLP (TF-IDF, análisis de sentimiento)
Deep learning con redes convolucionales (PyTorch)

- **Mi contacto**
- Linkedin: https://www.linkedin.com/in/jesus-antonio-prieto-064122349/
- Correo: jesusantonioprietocanez@gmail.com
